...
private:
	...
	Mesh processMesh(aiMesh *mesh, const aiScene *scene) {
		...
		for (unsigned int i = 0; i < mesh->mNumVertices; i++) {
			...
			//cout << "T:   " << vertex.Tangent.x << "  " << vertex.Tangent.y << "  " << vertex.Tangent.z << "\n";
			//cout << "B:   " << vertex.Bitangent.x << "  " << vertex.Bitangent.y << "  " << vertex.Bitangent.z << "\n";
			//cout << "N:   " << vertex.Normal.x << "  " << vertex.Normal.y << "  " << vertex.Normal.z << "\n\n\n";
